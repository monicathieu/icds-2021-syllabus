...
blogdown::shortcode_html(.name = "alert",
                         icon = "🛠️",
                         .content = "Form statement re campus disability accommodations office")
```
...
blogdown::shortcode_html(.name = "alert", 
                         icon = "🛠️",
                         .content = "Form statement from university re: campus physical and mental health services")
```
...
blogdown::shortcode_html(.name = "alert",
                         icon = "🛠️",
                         .content = "Form statement from university re: academic integrity")
```
